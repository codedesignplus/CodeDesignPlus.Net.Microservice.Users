...
public class UserDeletedDomainEvent : UserBaseDomainEvent
{
    ...
    public static UserDeletedDomainEvent Create(Guid aggregateId, string firstName, string lastName, string email, string phone, string? displayName, string documentNumber, DocumentType? documentType, bool isActive)
    {
