...
public class RemoveRoleCommandTest
{
    ...
    {
        // Arrange
        var command = new RemoveRoleCommand(Guid.Empty, Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid());
    ...
    {
        // Arrange
        var command = new RemoveRoleCommand(Guid.NewGuid(), Guid.NewGuid(), Guid.Empty, Guid.NewGuid());
    ...
    {
        // Arrange: se retira de una copropiedad concreta, nunca "de todas".
        var command = new RemoveRoleCommand(Guid.NewGuid(), Guid.Empty, Guid.NewGuid(), Guid.NewGuid());
